...
const runtime = fs.readFileSync(new URL('../api/runtime-config.js', import.meta.url), 'utf8');

assert.match(page, /fetch\('\/api\/runtime-config'/);
...
assert.match(runtime, /commerceRuntimeConfig/);
